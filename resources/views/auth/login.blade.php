...
<body>
    ...
    @if ($errors->any())
    <div style="background-color: #e10600; color: white; padding: 10px; margin-bottom: 15px; border-radius: 6px; font-weight: bold; font-size: 14px; max-width: 300px; margin-left: auto; margin-right: auto;">
